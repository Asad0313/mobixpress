            ...
            <div class="col-lg-4 single-right-left">
                <div class="grid images_3_of_2">
                    <div class="flexslider1">
                        <ul class="slides">
                            <li data-thumb="{{url('images',$wishlist->productimage)}}">
                                <div class="thumb-image">
                                    <img src="{{url('images',$wishlist->productimage)}}" data-imagezoom="true" alt=" " class="img-fluid" height="20" widht="10"> </div>
                            </li>
                            <li data-thumb="{{url('images',$wishlist->productimage)}}">
                                <div class="thumb-image">
                                    <img src="{{url('images',$wishlist->productimage)}}" data-imagezoom="true" alt=" " class="img-fluid" height="20" widht="10"> </div>
                ...
                <div class="total_area">
                    ...
                    <form method="post" action="/wishlist/{{$wishlist->id}}">
                        {{csrf_field()}}
                            ...
                            <button type="submit"    onclick="return confirm('Are you Sure you Want to Delete This Wishlist?')"
                    ...
                    <div class="total_area">
                        <a href="{{route('AddToCartProduct',$wishlist->pro_id)}}" class="  btn btn-default add-to-cart" style="color: white; width:500px; text-align: center; padding-top: 3px; border: black; border-radius: 5px;
