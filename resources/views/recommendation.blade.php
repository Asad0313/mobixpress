...
<head>
    ...
    <title>Recommender System in MobiXpress</title>
    <style>
        .large-product-image {
            width: auto;
            height: 200px;
...
<div align="left">
    <a href="{{url('/')}}" class="btn btn-danger mb1 black bg-darken-2">BACK</a>
...
{{--                <option value="{{ $product->id }}"></option>--}}
                ...
                <a href="{{url('/recommendation/'.$product->id)}}" style="text-decoration: none;">
                    {{csrf_field() }}
    ...
    <div class="row mb-5">
        <div class="offset-3 col-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text text-muted">{{ $selectedProduct->name }} (Rs{{ $selectedProduct->price }})</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="offset-3 col-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">{{ $product->name }} (RS{{ $product->price }})</p>
                    </div>
                </div>
            </div>
        </div>
